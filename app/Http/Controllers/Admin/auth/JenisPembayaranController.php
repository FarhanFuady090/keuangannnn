...
class JenisPembayaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = DB::table('jenispembayaran')
            ...
            ->select('jenispembayaran.*', 'unitpendidikan.namaUnit', 'tahunajaran.tahun_ajaran', 'tahunajaran.semester');
    ...
    {
        $tahunAjaran = TahunAjaran::where('status', 'Aktif')->get(['id', 'tahun_ajaran', 'semester']);
