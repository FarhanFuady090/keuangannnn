...
use App\Exports\SiswaYayasanExport;
...
class LapSiswaController extends Controller
{
    ...
    {
        return Excel::download(new SiswaYayasanExport($request), 'Laporan_Siswa_Yayasan.xlsx');
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('yayasan.laporan.siswa.export_pdf', compact('siswas', 'unitpendidikan'))
                ->setPaper('A4', 'landscape');

        return $pdf->download('Laporan_Data_Siswa_Yayasan.pdf');
    }
}
