                ...
                <div class="overflow-x-auto">
                    <table id="data-table" class="min-w-full bg-white border border-gray-300">
                        <tr class="bg-green-500 text-white text-center">
                            ...
                            <th class="py-2 px-4 border-r border-gray-300">Tahun Ajaran</th>
                            <th class="py-2 px-4 border-r border-gray-300">Awal</th>
                            <th class="py-2 px-4 border-r border-gray-300">Akhir</th>
                            <th class="py-2 px-4 border-r border-gray-300">Semester</th>
                        ...
                        @foreach ($tahunajaran as $no=>$data)
                            <tr class="bg-white text-black text-center border-b border-gray-300">
                                ...
                                <td class="py-2 px-4 border-r border-gray-300">{{ $data->tahun_ajaran }}</td>
                                <td class="py-2 px-4 border-r border-gray-300">{{ \Carbon\Carbon::parse($data->awal)->translatedFormat('d F Y') }}</td>
                                <td class="py-2 px-4 border-r border-gray-300">{{ \Carbon\Carbon::parse($data->akhir)->translatedFormat('d F Y') }}</td>
                                <td class="py-2 px-4 border-r border-gray-300">{{ $data->semester }}</td>
