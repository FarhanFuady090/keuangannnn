            ...
            <li>
                <x-nav-link aria-controls="dropdown-laporan" data-collapse-toggle="dropdown-laporan"
                    :active="request()->routeIs('yayasan.laporan.siswa.index') ||
                            ...
                            request()->routeIs('yayasan.laporan.tagihan.index')
                            ">
                            <!-- Ikon laporan -->
                ...
                <ul id="dropdown-laporan"
                    ...
                    <li>
                        <a href="{{ route('yayasan.laporan.tagihan.index') }}"
                            class="flex items-center w-full p-2 text-green-100 transition duration-75 rounded-lg pl-11 group hover:bg-green-800 dark:text-white dark:hover:bg-green-700
                            {{ request()->routeIs('yayasan.laporan.tagihan.index') ? 'bg-green-700' : '' }}">
                            <!-- Ikon laporan -->
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-gray-100 dark:group-hover:text-white"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd" d="M5 3a2 2 0 0 0-2 2v14.293c0 .89 1.077 1.337 1.707.707L6 19.707l1.293 1.293a1 1 0 0 0 1.414 0L10 19.707l1.293 1.293a1 1 0 0 0 1.414 0L14 19.707l1.293 1.293a1 1 0 0 0 1.414 0L18 19.707l1.293 1.293c.63.63 1.707.183 1.707-.707V5a2 2 0 0 0-2-2H5zm5 5a1 1 0 1 1 0-2h4a1 1 0 1 1 0 2h-4zm-2 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1zm1 3a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2H9z" clip-rule="evenodd" />
                            </svg>
                            <span class="text-white flex-1 ms-3 whitespace-nowrap">
                            Tagihan</span>
                        </a>
