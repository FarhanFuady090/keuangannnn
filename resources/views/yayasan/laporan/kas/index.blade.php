...
<x-layout-yayasan>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <form method="GET" action="{{ route('yayasan.laporan.kas.index') }}" class="flex flex-wrap gap-3 items-center mb-4">
            ...
            <!-- Tahun Ajaran -->
            <select name="tahun_ajaran_id" class="border border-gray-300 rounded px-4 py-2">
            ...
            <a href="{{ route('yayasan.laporan.kas.export', request()->query()) }}"
                class="bg-blue-600 text-white px-4 py-2 rounded text-sm">
                    Export Excel
            </a>

            <a href="{{ route('yayasan.laporan.kas.export.pdf', request()->query()) }}"
